...
CREATE TABLE IF NOT EXISTS school_profiles (
  ...
  focus_areas JSON NOT NULL COMMENT '面試重點領域陣列',
...
CREATE TABLE IF NOT EXISTS daily_tasks (
  ...
  question_ids JSON COMMENT '題目ID陣列',
...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  question_ids JSON COMMENT '題目ID陣列（會話創建時選擇的完整題目列表）',
...
CREATE TABLE IF NOT EXISTS session_summaries (
  ...
  strengths JSON COMMENT '優勢點陣列',
  weaknesses JSON COMMENT '薄弱點陣列',
...
CREATE TABLE IF NOT EXISTS interview_memories (
  ...
  extracted_questions JSON COMMENT 'AI提取的題目陣列',
